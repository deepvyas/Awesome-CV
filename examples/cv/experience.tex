...
\cventry
    ...
    {Nov. 2024 - PRESENT} % Date(s)
    {
      \begin{cvitems} % Description(s)
        \item {Leading a pod for optimizing and automating vertical scaling of a large MongoDB fleet and also driving efficiency projects to improve cost per unit storage, while maintaining 99.99995\% of uptime of datbases}
        \item {Also responsible for diving deep into novel issues that pop out of running MongoDB at scale and optimizing and tuning the engine for being able to serve 5M+ QPS}
        \item {Part of the working group responsible for maintaining version currency of MongoDB at Stripe, upgrading a large fleet of databases with 0 down-time and 0 end-user facing incidents.}
      \end{cvitems}
    }
%---------------------------------------------------------
